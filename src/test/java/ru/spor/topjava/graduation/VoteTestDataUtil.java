...
public class VoteTestDataUtil {
    ...
    public static final LocalDateTime VOTE_DATE_TIME_NEW_BEFORE = LocalDateTime.of(2019, 8, 20, 10, 5);
    public static final LocalDateTime VOTE_DATE_TIME_NEW_AFTER = LocalDateTime.of(2019, 8, 20, 11, 5);
    public static final LocalDateTime VOTE_DATE_TIME_BEFORE = LocalDateTime.of(2019, 8, 19, 10, 3);
    public static final LocalDateTime VOTE_DATE_TIME_AFTER = LocalDateTime.of(2019, 8, 19, 11, 5);

    public static final Vote USER_VOTE_1 = new Vote(VOTE_ID, LocalDate.of(2019, 8, 18), FIRST_RESTAURANT, USER);
    public static final Vote USER_VOTE_2 = new Vote(VOTE_ID + 2, LocalDate.of(2019, 8, 19), FIRST_RESTAURANT, USER);

    public static final Vote ADMIN_VOTE_1 = new Vote(VOTE_ID + 1, LocalDate.of(2019, 8, 18), FIRST_RESTAURANT, ADMIN);
    public static final Vote ADMIN_VOTE_2 = new Vote(VOTE_ID + 3, LocalDate.of(2019, 8, 19), SECOND_RESTAURANT, ADMIN);
